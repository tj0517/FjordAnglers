...
| FA-0.06 | `requireAdmin()` we wszystkich mutujących akcjach | M | sonnet | review | — |
...
| FA-0.10 | Google Ads sync — martwy/zły token (cron 500 mimo naprawionego routingu) | S | sonnet | review | — |
